...
public class XmdsMarshalDate implements Marshal
{
    ...
    {
        return XmdsHelper.ConvertFromWebService(parser.nextText());
    }
    ...
    {
        writer.text(XmdsHelper.getDateFormat().format((Date)obj));
    }
}
